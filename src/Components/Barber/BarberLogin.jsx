...
import login from "../../images/b1.jpg";
...
export default function BarberLogin() {
  ...
  const onsubmit = async (event) => {
    ...
    try {
      console.log(LogData);
      const res = await axios.post('/Barber/login', LogData);
      if (res.status === 201) {
                    ...
                    <div className="card-body p-4 p-lg-5 text-black">
                      ...
                      <form method='POST' onSubmit={onsubmit}>
                        ...
                        <div className="d-flex align-items-center mb-3 pb-1">
                          ...
                          <span className="h1 fw-bold mb-0">BARBER LOGIN</span>
                        </div>
                      ...
                      {
                        Response.error && <div className="alert alert-warning mt-5 text-danger" role="alert">
